...
import (
	...
	grpc "github.com/ksimir/grpc-go-api/pkg/protocol/grpc/player-server"
	v1 "github.com/ksimir/grpc-go-api/pkg/service/v1/player-service"
)
...
func RunServer() error {
	...
	if err != nil {
		logger.Log.Fatal("Failed to connect to Cloud Spanner")
		log.Fatal(err)
	}
